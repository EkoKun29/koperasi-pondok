            ...
            <div class="p-6">
                <div class="flex">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="tanggal" name="tanggal" class="form-input mt-1 block w-full px-3 py-2 text-lg border-2 border-gray-400 rounded-lg" required
                ...
                <div class="flex justify-end mt-6">
                    <a href="{{ route('penjualan-acara.index') }}" class="btn btn-warning">Kembali</a>
...
<script>
    ...
    function submitAll() { 
        ...
        if (!tanggal || !nama_personil || !shift || totalPembayaran === 0) {
        ...
        $.ajax({
            url: "{{ route('penjualan-acara.store') }}",  // Route Laravel untuk penyimpanan
            method: "POST",
            data: {
                tanggal: tanggal,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    window.location.href = "{{ url('penjualan-acara/print') }}/" + uuid;
                } else {
