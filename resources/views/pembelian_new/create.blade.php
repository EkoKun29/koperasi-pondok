                ...
                <div class="flex">
                    <div class="w-full md:w-1/2">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="pindah_barang" name="pindah_barang" class="form-input mt-1 block w-full px-3 py-2 text-lg border-2 border-gray-400 rounded-lg">
                                <option disabled selected>Pilih Masuk Ke-</option>
                                @foreach($db as $dbm)
                                    <option value="{{ $dbm->tipe_po }}">{{ $dbm->tipe_po }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    function submitAll() { 
        ...
        $.ajax({
            ...
            method: "POST",
            contentType: "application/json", // ⬅️ wajib
            data: JSON.stringify({
                nama_supplier: nama_supplier,
                pindah_barang: pindah_barang,
