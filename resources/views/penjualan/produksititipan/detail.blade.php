            ...
            <form id="createpenjualanTransfer" action="#" method="POST">                                   
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <div class="d-flex">
                             <a href="{{ route('delete-penjualan-titipan-detail', $dtl['id']) }}" id="btn-delete-post" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Barang {{ $dtl->nama_barang }} ??')"
