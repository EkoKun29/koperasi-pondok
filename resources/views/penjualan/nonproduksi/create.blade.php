...
<div class="container mx-auto mt-6">
    <h1 class="text-xl font-semibold mb-4">Tambah Penjualan Non Produksi</h1>
    <div class="w-full">
            ...
            <div class="p-6">
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table id="tbl_penjualan_nonproduksi" class="table table-bordered table-hover mb-5 overflow-auto">
                            <thead>
                                <tr>
                            ...
                            <tbody id="tbl_body_penjualan_nonproduksi">
                            </tbody>
                        </table>
                    </div>
                </div>
...
<div id="modalTambahBarang" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="createPenjualanNonProduksi">
...
<script>
    ...
    function addItem() {
        ...
        var rowCount = $('#tbl_body_penjualan_nonproduksi tr').length;
        $('#tbl_body_penjualan_nonproduksi').append(`
            <tr>
                <td>${rowCount + 1}</td>
                <td>${nama_barang}</td>
                <td>${harga}</td>
        ...
        $('#createPenjualanNonProduksi')[0].reset();
    ...
    function updateTable() {
        $('#tbl_body_penjualan_nonproduksi').empty();
    ...
    function submitAll() { 
        ...
        $.ajax({
            url: "{{ route('penjualan-nonproduksi.store') }}",  // Route Laravel untuk penyimpanan
            method: "POST",
            data: {
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    window.location.href = "{{ url('penjualan-nonproduksi/print') }}/" + uuid;
                } else {
