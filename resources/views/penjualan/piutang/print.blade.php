...
<body>
    <div class="ticket">
        <p class="centered"><b><strong>KOPERASI KAMPUS {{ Auth::user()->role }}</strong></b>
            <br>
            <b><strong>NOTA PENJUALAN PIUTANG</strong></b>
        </p>
        <p style="font-size: 1.2em; ">
            <strong>
            <br>KARYAWAN : {{  $piutang->nama_personil }}
            <br>NOTA : {{ $piutang->no_nota }}
            <br>TANGGAL : {{ $piutang->created_at->format('d/m/y') }}
            <br>JENIS TRANSAKSI : PIUTANG
            <br>NAMA KONSUMEN : {{ $piutang->nama_pembeli }}
            </strong>
            <hr>
        </p>
        <table>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td class="description" style="text-align: right; font-weight: bold; font-size: 1.8em;">Rp {{number_format($piutang->total, 2, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
        <hr>
