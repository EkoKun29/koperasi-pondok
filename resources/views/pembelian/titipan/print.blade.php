...
<body>
    <div class="ticket">
        <p class="centered"><b><strong>KOPERASI KAMPUS {{ Auth::user()->role }}</strong></b>
            <br>
            <b><strong>NOTA PEMBELIAN TITIPAN</strong></b>
        </p>
        <p style="font-size: 1.2em; ">
            <strong>
            <br>KARYAWAN : {{  $titipan->nama_personil }}
            <br>NOTA : {{ $titipan->no_nota }}
            <br>TANGGAL : {{ $titipan->created_at->format('d/m/y') }}
            <br>JENIS TRANSAKSI : TITIPAN
            <br>NAMA PENITP : {{ $titipan->nama_penitip }}
            </strong>
            <hr>
        </p>
        <table>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td class="description" style="text-align: right; font-weight: bold; font-size: 1.8em;">Rp {{number_format($titipan->total, 2, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
        <hr>
