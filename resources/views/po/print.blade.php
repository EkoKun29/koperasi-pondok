...
<body>
    <div class="ticket">
        <p class="centered"><b><strong>KOPERASI KAMPUS {{ Auth::user()->role }}</strong></b>
            <br>
            <b><strong>NOTA PENGAJUAN PO</strong></b>
        </p>
        <p style="font-size: 1.2em; ">
            <strong>
            <br>KARYAWAN : {{  $po->nama_pengaju }}
            <br>NOTA : {{ $po->no_nota }}
            <br>TANGGAL PENGAJUAN: {{ $po->tanggal }}
            <br>JENIS TRANSAKSI : PENGAJUAN
            </strong>
            <hr>
        </p>
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="description" style="text-align: right; font-size: 1.2em; ">Rp {{number_format($item->total, 2, ',', '.') }}</td>
                </tr>
                <tr>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td class="description" style="text-align: right; font-weight: bold; font-size: 1.8em;">Rp {{number_format($po->total, 2, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
        <hr>
