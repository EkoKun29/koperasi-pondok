...
<div class="container mx-auto mt-6">
    <h1 class="text-xl font-semibold mb-4">Tambah Pengajuan Po</h1>
    <div class="w-full">
            ...
            <div class="p-6">
                <div class="flex">
                    <div class="w-full md:w-1/2">
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700"><b>Nama Pengaju</b></label>
...
<script>
    ...
    function submitAll() { 
        ...
        if (!nama_pengaju || !tanggal || totalPembayaran === 0) {
            alert("Semua field harus diisi dan total pembayaran harus dihitung.");
            return;
        }

        $.ajax({
            url: "{{ route('pengajuan-po.store') }}",  // Route Laravel untuk penyimpanan
            method: "POST",
            data: {
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    window.location.href = "{{ url('pengajuan-po/print') }}/" + uuid;
                } else {
