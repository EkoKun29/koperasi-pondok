...
class PenjualanNonProduksiController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->role == 'admin') {
            $nonproduksi = PenjualanNonProduksi::orderBy('uuid', 'desc')->get();
            ...
            $nonproduksi = PenjualanNonProduksi::whereIn('id_user', $usersWithRole2)->orderBy('uuid', 'desc')->get();

        }elseif(Auth::user()->role == '3'){
            $usersWithRole3 = User::where('role', '3')->pluck('id');
            $nonproduksi = PenjualanNonProduksi::whereIn('id_user', $usersWithRole3)->orderBy('uuid', 'desc')->get();

        }elseif(Auth::user()->role == '4'){
            $usersWithRole4 = User::where('role', '4')->pluck('id');
            $nonproduksi = PenjualanNonProduksi::whereIn('id_user', $usersWithRole4)->orderBy('uuid', 'desc')->get();
