...
class PengajuanPoController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->role == 'admin') {
            $po = PengajuanPo::orderBy('uuid', 'desc')->paginate(10);
            ...
            $po = PengajuanPo::whereIn('id_user', $usersWithRole2)->orderBy('uuid', 'desc')->paginate(10);

        }elseif(Auth::user()->role == '3'){
            $usersWithRole3 = User::where('role', '3')->pluck('id');
            $po = PengajuanPo::whereIn('id_user', $usersWithRole3)->orderBy('uuid', 'desc')->paginate(10);

        }elseif(Auth::user()->role == '4'){
            $usersWithRole4 = User::where('role', '4')->pluck('id');
            $po = PengajuanPo::whereIn('id_user', $usersWithRole4)->orderBy('uuid', 'desc')->paginate(10);
